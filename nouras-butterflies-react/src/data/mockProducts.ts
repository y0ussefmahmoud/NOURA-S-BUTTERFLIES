...
export const mockProducts: Product[] = [
  {
    ...
    description:
      'A nourishing lip treatment that provides long-lasting hydration and a natural, glossy finish.',
    price: 24.0,
    compareAtPrice: 32.0,
    images: [
      {
        ...
        thumbnail:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuBAwK_Apm9-W0ywaM_UxvjPX_IDVvPnPBXpnuVyBqwRGumI7PgoYwGRAkC1YU1jC2suWjNLrcGkmfEVayHJCEBDB-gi9S4dvzNXNi2zCB5YcLv_pcHXc7qKa2jpKb8PnfgAmVMOkura49F3twwAm-rss-ff-JzkdB4rFWqkjqmNuud02M2OoFfoy8ky79Fek8ea9Q6gmyV3-KRURyc07YgVJD4FpKks_X2cb4N0DZ0aDJ8Flp8eQ3InKcGHHWhdE50qmSe4Sh5qfbY',
      },
      {
    ...
    rating: 4.9,
    reviewCount: 245,
    badges: [{ type: 'bestseller' }, { type: 'vegan' }, { type: 'cruelty-free' }],
    category: 'lip-gloss',
    inStock: true,
    isBestseller: true,
    variants: [
      ...
      ingredients: [
        {
          ...
          name: 'Rosehip Oil',
          description:
            'Rich in vitamins A and C, helps to brighten and even out lip tone while providing deep hydration.',
          number: 1,
        },
        {
          id: 'ing-2',
          name: 'Desert Honey',
          description:
            'Natural humectant that locks in moisture and provides antibacterial properties for healthy lips.',
          number: 2,
        },
        {
          id: 'ing-3',
          name: 'Shea Butter',
          description:
            'Deeply nourishing and helps to repair dry, chapped lips with essential fatty acids.',
          number: 3,
        },
        {
          id: 'ing-4',
          name: 'Vitamin E',
          description:
            'Powerful antioxidant that protects lips from environmental damage and premature aging.',
          number: 4,
        },
      ],
      howToUse: {
        steps: [
          ...
          },
          {
            ...
            description:
              'Swipe the applicator across your lips, starting from the center and moving outward.',
          },
          {
            stepNumber: 3,
            title: 'Build as Needed',
            description:
              'Layer for more intensity and shine. Reapply throughout the day as desired.',
          },
        ],
        videoThumbnail: {
  ...
  },
  {
    ...
    description:
      'A lightweight cheek tint that gives your cheeks a natural, healthy glow with buildable color.',
    price: 18.0,
    compareAtPrice: 24.0,
    images: [
      {
        ...
        thumbnail:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuBxHD1agpHaqfyT4ibpFa6CIYXYv1n1WFXOEtairt0vIKDL_zgL6V8-DIiWfgvuW17tKDsDGsxk8z29xUokzx6EEzU61oYppa_7S2W4xMjK1LnprjW4fm8x5iUM8msJBQTKPPm0LiMtTxdXeJxNaBOBrznqcs1sYA9oDdD1lbLbnwIf7D-MODWRZG39Yz52SPdaCQwcJ0jVRr33Oo98nvALa105Naytw2UnrZswWk3Jk8-0qloyHSlfhSKCPpEbLMjt59HEao3dQqs',
      },
    ],
    rating: 4.8,
    reviewCount: 189,
    badges: [{ type: 'vegan' }, { type: 'cruelty-free' }, { type: 'paraben-free' }],
    category: 'blush',
    inStock: true,
    isBestseller: false,
    variants: [
  ...
  },
  {
    ...
    description:
      'A luxurious setting powder that gives your skin a smooth, matte finish with a silk-like texture.',
    price: 32.0,
    compareAtPrice: 40.0,
    images: [
      {
        ...
        thumbnail:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuATa-tK7F6aY5QuldDk_TLc0GVvCHtKxBebDiR0fGQHaO7K2sqDs2fMQO0udUt9PRifsOliw1a_95UpIjHxUXdV1fxcn0QFfRbdO09iuXLVRpcHY78fn1op8hqJR0TxrhfyJfy4ZbtphR1Xn_VlwRxFITFecH6zgy0FO3FwFJF8UArsAQjVVM50frizZb_8F7niTl5ebof9mCRA8vFytwHD0VVpm8DqGjkfuodLsJkJWfApu4BWvt__H-yT098jbUuUfvCaACp_0F8',
      },
    ],
    rating: 5.0,
    reviewCount: 156,
  ...
  },
  {
    ...
    description:
      'A lightweight face oil that deeply nourishes and hydrates your skin without feeling greasy.',
    price: 45.0,
    compareAtPrice: 55.0,
    images: [
      {
        ...
        thumbnail:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuAJFCqur_jjctPnveIX_t9a_pxdgZZuLu3TIV_nzO8fnOkyKmHOD_e2JIX24fKqsvxZQrl09a9CpcJmmwSx6p3WxmdLkYGeSWuzs4vJeg9rYKb7ZA2u2ih2SGeYfTFy76efSo-7dmb3aVri8PqJPQY2v8L3kEW_Wcc-zgM62ckNoCuyPi61TZ84wxsVh8aM1sk64tUbQMLtlfPubjjF2D0SmJT9w2AuL-0iepAy5X1aDEjQSrIfNsvs5ebo1Mpq70RJOaTDWf38Egs',
      },
    ],
    rating: 4.7,
    reviewCount: 203,
    badges: [{ type: 'vegan' }, { type: 'cruelty-free' }, { type: 'organic' }],
    category: 'skincare',
    inStock: true,
    isBestseller: false,
    variants: [],
